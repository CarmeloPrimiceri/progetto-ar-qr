...
class ARExperience {
    ...
    loadModel(target, targetIndex) {
        ...
        // Posiziona il modello sopra il marker e ingrandiscilo
        modelEntity.setAttribute('position', "0 0.75 0"); // Sopra il marker
        modelEntity.setAttribute('scale', "1.5 1.5 1.5"); // Più grande
